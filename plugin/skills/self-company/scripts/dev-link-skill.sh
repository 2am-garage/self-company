...
# skill's real source now lives at `plugin/skills/self-company/` (SKILL.md, scripts/,
...
#
# Usage: plugin/skills/self-company/scripts/dev-link-skill.sh
###############################################################################
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# scripts is at REPO/plugin/skills/self-company/scripts -> repo root is four levels up.
...
# ONE symlink: .claude/skills/self-company -> ../../plugin/skills/self-company (relative).
# The real skill dir already exists under plugin/skills/self-company; dev-link just
...
ln -sfn "../../plugin/skills/self-company" "$link"
echo "[dev-link-skill] linked .claude/skills/self-company -> ../../plugin/skills/self-company"
