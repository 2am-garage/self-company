...
RUNNER="cd '$PROJECT_DIR' && $PATH_PREFIX bash '$PROJECT_DIR/.company/scripts/daily-run.sh' '$PROJECT_DIR' >> '$LOGFILE' 2>&1"
LINE="$CRON_EXPR $RUNNER $MARK"
RESEARCH_RUNNER="cd '$PROJECT_DIR' && $PATH_PREFIX bash '$PROJECT_DIR/.company/scripts/research-scan.sh' '$PROJECT_DIR' >> '$LOGFILE' 2>&1"
