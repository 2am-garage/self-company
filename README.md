...
> Hooks need **no** setup: since v0.1.2 all 9 registrations across 7 events are **plugin-native** (declared in
...
Event-driven (not cron): **9 plugin-native hook registrations across 7 events** work automatically. `Stop`/`PreCompact`
